...
async def get_user_stats(
    ...
    try:
        ...
        detections_count = db.execute(text("""
    ...
    try:
        ...
        for analysis in recent_analyses:
            activities.append({
                ...
                "timestamp": analysis[4].isoformat() if analysis[4] else datetime.utcnow().isoformat(),
                "metadata": {
        ...
        if current_user.role in ["ADMIN", "EXPERT"]:
            ...
            for validation in recent_validations:
                activities.append({
                    ...
                    "timestamp": validation[3].isoformat() if validation[3] else datetime.utcnow().isoformat(),
                })
