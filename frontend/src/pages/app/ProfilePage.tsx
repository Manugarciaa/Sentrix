    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Activity Timeline */}
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4 flex items-center gap-2">
        ...
        <div className="space-y-6">
          {/* Stats Card */}
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Estadísticas</h2>
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                <div className="p-4 bg-status-info-light rounded-lg">
                  <p className="text-sm text-status-info-text mb-1">Análisis Totales</p>
                  <p className="text-3xl font-bold text-status-info-text">{stats.total_analyses}</p>
                </div>
          ...
          {/* Account Status */}
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Estado de Cuenta</h2>
