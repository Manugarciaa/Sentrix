...
const ReportsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showConfigForm && (
        <Card className="p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold text-foreground">Configurar Reporte</h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            {/* Additional Options */}
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-3">Opciones Adicionales</h3>
      ...
      {/* Reports List */}
      <div>
        <h2 className="text-lg font-bold text-foreground mb-4">Reportes Generados</h2>
