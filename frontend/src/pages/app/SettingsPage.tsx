    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-base text-gray-700 dark:text-muted-foreground mt-2">
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general" className="mt-6">
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Configuración General</h2>
        ...
        <TabsContent value="notifications" className="mt-6">
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Preferencias de Notificaciones</h2>
        ...
        <TabsContent value="analysis" className="mt-6">
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Configuración de Análisis</h2>
        ...
        <TabsContent value="privacy" className="mt-6">
          <Card className="p-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-foreground mb-4">Configuración de Privacidad</h2>
            ...
            <div className="space-y-6">
              ...
              {/* Privacy Notice */}
              <div className="mt-6 p-4 bg-status-info-light border border-status-info-border rounded-lg">
                <h4 className="text-sm font-semibold text-status-info-text mb-2">
                  Sobre tu Privacidad
                </h4>
                <p className="text-xs text-status-info-text leading-relaxed">
        ...
        <div className="fixed bottom-6 right-6 bg-white border-2 border-primary-500 rounded-lg shadow-lg p-4 max-w-sm">
          <div className="flex items-start gap-3">
            <div className="shrink-0 w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center">
              <Save className="h-5 w-5 text-primary-600 dark:text-primary" />
            </div>
            <div className="flex-1">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  disabled={isSaving}
                  className="bg-primary-600 dark:bg-primary"
                >
                  Guardar
                </Button>
              </div>
