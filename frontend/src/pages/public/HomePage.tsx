...
const HomePage: React.FC = () => {
  ...
  const stats = [
    { label: 'Análisis Realizados', value: '1,234+' },
    { label: 'Criaderos Detectados', value: '456+' },
    { label: 'Usuarios Activos', value: '89+' },
    { label: 'Cobertura', value: '15 Distritos' },
  ]
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
              Control Inteligente
              <span className="block text-primary-600">del Dengue</span>
            </h1>
            <p className="mx-auto mt-8 max-w-2xl text-xl text-gray-600 leading-relaxed">
              Plataforma que utiliza inteligencia artificial para detectar criaderos de Aedes aegypti
              y prevenir la propagación del dengue.
            </p>
