...
export interface Analysis {
  ...
  processed_image_filename?: string
...
export interface PaginatedResponse<T> {
  ...
  items?: T[]        // Legacy format
  analyses?: T[]     // Backend format for analyses
  total: number
  page?: number      // Legacy format
  per_page?: number  // Legacy format
  pages?: number     // Legacy format
  limit?: number     // Backend format
  offset?: number    // Backend format
  has_next?: boolean // Backend format
}
